function MT_localizer_old3( Subj, Durat, Emulate )
% MT_localizer_old3
%
...
%     while CurrTime<=countCycle*CycleDuration 
    if mod((floor(CurrTime/CycleDuration)),2)==0
        ...
        [triggers,Behaviour]=drawDots19032014(display,dots(1),design.stimDur,triggers,KeyCodes,Behaviour,CyclingStart);
        ...
        [triggers,Behaviour]=drawDots19032014(display,dots(1),CycleDuration,triggers,KeyCodes,Behaviour,CyclingStart);
